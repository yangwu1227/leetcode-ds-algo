...
def main() -> int:
    ...
    print(f"Given s = '{s}', t = '{t}', and max cost = {max_cost}, the maximum length of a substring of 's' that can be changed to be the same as the corresponding substring of 't' is {window_len}")
