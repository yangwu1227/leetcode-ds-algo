...
def main() -> int:
    ...
    for s1, s2 in [["a", "ab"], ("ab", "eidbaooo"), ["ab", "eidboaoo"], ("adc", "dcda")]:
        contains_perm = check_inclusion(s1, s2)
        print(f"The string '{s2}' {'contains' if contains_perm else 'does not contain'} a permutation of the string '{s1}'")
