...
def smallest_string(s: str) -> str:
    ...
    # Print initial state
    print(
        f"Initial state -> original_deque: {list(original_deque)}, temp_deque: {list(temp_deque)}, output: {list(output)}, smallest_right: {smallest_right}"
    )
    ...
    while original_deque or temp_deque:
        ...
        print(
            f"Action: {action} -> original_deque: {list(original_deque)}, temp_deque: {list(temp_deque)}, output: {list(output)}"
        )
